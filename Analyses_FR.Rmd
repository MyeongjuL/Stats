...
plot(density(df_FR_cond$FR, na.rm=TRUE), col="green",main="Density comparison", ylim=c(0, max_y), xlim=c(0, max_x), xlab("FP rate (freq/min)"))
...
plot(density(df_FR_cond[(df_FR_cond$QuestionType == "Main"),]$FR), col="red", main="Density comparison: per condition", ylim=c(0, max_y2), xlab("FP rate (freq/min)"))
...
plot(density(df_FR_turn[(df_FR_turn$QuestionType == "Main"),]$FR), col="red", main="Density comparison: per turn", ylim=c(0, max_y3), xlim=c(0, max_x3), xlab("FP rate (freq/min)"))
...
ggplot(plot_FR_item, aes(x = ResponseCond, y = FR, fill = ResponseCond)) +
  ...
  theme_bw() +
  ylab("Filler Particle Rate (freq/min)") +
  xlab("Response Condition") +
  ggtitle("Filler Particle Rate by Response Condition") +
