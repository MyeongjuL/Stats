...
plot(density(df_SR_main$SR), col="red", main="Density comparison", ylim=c(0, max_y))
...
plot(density(df_SR_main$SR), col="red", main="Density comparison", ylim=c(0, max_y2))
lines(density(df_SR_folu$SR), col="blue")
legend("topright", legend=c("Main", "Follow-up"), col=c("red","blue"), lty=1)
```
...
plot(density(df_SR_main$SR), col="red", main="Density comparison", ylim=c(0, max_y3))
lines(density(df_SR_folu$SR), col="blue")
legend("topright", legend=c("Main", "Follow-up"), col=c("red","blue"), lty=1)
```
...
## Speaking Rate: means
```{r}
summarySE(df_SR, measurevar = "SR", groupvars = c("ResponseCond"), na.rm = T)
...
ggplot(plot_SR, aes(x = ResponseCond, y = SR, fill = ResponseCond)) +
  ...
  ylab("Speaking Rate") +
  xlab("Truthfulness") +
  ggtitle("Speaking Rate by Truthfulness") +
...
ggplot(plot_SR_main, aes(x = ResponseCond, y = SR, fill = ResponseCond)) +
  ...
  ylab("Speaking Rate") +
  xlab("Truthfulness") +
  ggtitle("Speaking Rate after Main Question by Truthfulness") +
  scale_x_discrete(labels=c("T"="Truthful", "D"="Deceptive")) +
  geom_errorbar(aes(ymin=SR-se, ymax=SR+se), linewidth=.5, width=.2, position=position_dodge(0.6)) +
  scale_fill_manual(values = c("D"="#FF7C80", "T"="#8ED973")) +
  theme(legend.position = "none", axis.text = element_text(size = 12), axis.title = element_text(size = 14), 
...
ggplot(plot_SR_folu, aes(x = ResponseCond, y = SR, fill = ResponseCond)) +
  ...
  ylab("Speaking Rate") +
  xlab("Truthfulness") +
  ggtitle("Speaking Rate after Follow-up Question by Truthfulness") +
  scale_x_discrete(labels=c("T"="Truthful", "D"="Deceptive")) +
  geom_errorbar(aes(ymin=SR-se, ymax=SR+se), linewidth=.5, width=.2, position=position_dodge(0.6)) +
  scale_fill_manual(values = c("D"="#FF7C80", "T"="#8ED973")) +
  theme(legend.position = "none", axis.text = element_text(size = 12), axis.title = element_text(size = 14),
...
ggplot(plot_SR_main_folu, aes(x = QuestionType, y = SR, fill = ResponseCond)) +
  ...
  ylab("Speaking Rate") +
  xlab("Question Type") +
  ggtitle("Speaking Rate by Question Type and Truthfulness") +
...
```{r}  
power_SR_part <- powerCurve(Model_SR_Corr,
...
```{r}  
power_SR_turn <- powerCurve(Model_SR_Corr,
                         fixed("ResponseCond1", "z"),
                         along = "QuestionNum",
                         breaks = c(250, 300, 350, 400, 450, 500, 550, 600),
                         nsim = 100,
                         alpha = .045,
                         progress = FALSE)
plot(power_SR_turn)
